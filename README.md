...
Static GitHub Pages landing page for the teen / young adult AiTHOS Health Passport concept. Includes the AiTHOS logo in the top-left header and a prototype Concierge toggle showing a safe, non-PHI patients-under-management panel.
...
- `script.js` — prototype form behavior, Passport preview, and Concierge panel toggle
...
The header includes a **Concierge** button that opens/closes a prototype management panel. The panel intentionally displays only safe workflow status and mock patient initials; it should not be used to display PHI without a secure backend, role-based access, audit logging, and legal review.
